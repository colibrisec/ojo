...
- **Filesystems and source repos** (`ojo fs`) — dependency manifests, hardcoded secrets, Dockerfile/Kubernetes/Terraform misconfiguration, and Go source code
...
| [Secret](guide/scanner/secret.md) | Hardcoded credentials, API keys, tokens, private keys | On |
...
| [SAST](guide/scanner/sast.md) | Injection, weak crypto, and other Go source-level issues | Off (`--scanners sast`) |
